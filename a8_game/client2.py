...
def move_ghost(direction, screen) -> None:
    ...
    if grid[new_row][new_col] != 1:
        ...
        grid[new_row][new_col] = 4  # Move ghost
        ghost2_pos = (new_row, new_col)

    check_collision(screen)
    move_pacman(screen)

def move_ghosts(direction, screen) -> None:
    global ghost1_pos
    row, col = ghost1_pos
    new_row, new_col = row, col
    if direction == "UP":
...
def check_collision(screen):
    ...
    if ghost2_pos == pacman_pos:
        ...
        grid[ghost2_pos[0]][ghost2_pos[1]] = 4
...
def main() -> None:
    global current_direction, ghost1_direction, client_id_recv
        ...
        if client_id_recv == 2:
            if packet_type_recv == 1:
                if direction != 0:
                    ...
                    move_ghosts(ghost1_direction, screen)
